...
<?php $__env->startSection('title', 'Dompet Saya - JajanGaming'); ?>

<?php $__env->startSection('content'); ?>
<!-- Page Container with Sidebar -->
<div style="display: flex; min-height: calc(100vh - 80px);">
    <?php echo $__env->make('partials.sidebar', ['sidebarTitle' => 'My Wallet'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    ...
    <div class="container">
        <div class="page-header d-flex justify-content-between align-items-center flex-wrap">
            <h1 class="page-title">
                ...
                <?php echo e(auth()->user()->isSeller() ? 'Dompet Penghasilan' : 'Dompet Saya'); ?>
            ...
            <div class="balance-card">
                <div class="balance-header">
                    ...
                    <div class="balance-label">
                        <?php echo e(auth()->user()->isSeller() ? 'Total Pendapatan' : 'Saldo Saat Ini'); ?>

                    </div>
                    <div class="balance-amount">
                        <?php if(auth()->user()->isSeller()): ?>
                            Rp <?php echo e(number_format(\App\Models\Order::whereHas('orderItems.product', function($q){ $q->where('seller_name', auth()->user()->name); })->where('status','completed')->sum('total_amount'), 0, ',', '.')); ?>

                        <?php else: ?>
                            Rp <?php echo e(number_format($user->wallet_balance, 0, ',', '.')); ?>
                ...
                <div class="balance-body">
                    <?php if(!auth()->user()->isSeller()): ?>
                    <form action="<?php echo e(route('wallet.topup')); ?>" method="POST" class="topup-form">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                   ...
                                   value="<?php echo e($requiredAmount ?? ''); ?>" 
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <?php if($requiredAmount): ?>
                                <div class="form-hint warning">
                                    <i class="fas fa-exclamation-triangle"></i>
                                    Anda membutuhkan minimal Rp <?php echo e(number_format($requiredAmount, 0, ',', '.')); ?> untuk menyelesaikan pesanan Anda.
                                </div>
                            <?php else: ?>
                        ...
                        <?php if($requiredAmount): ?>
                        <a href="<?php echo e(route('cart.index')); ?>" class="btn-topup btn-secondary">
            ...
            <div class="info-card">
                <div class="info-header">
                    <i class="fas fa-info-circle"></i>
                    <h3><?php echo e(auth()->user()->isSeller() ? 'Informasi Pendapatan' : 'Informasi Dompet'); ?></h3>
                </div>
                <div class="info-body">
                    <ul class="info-list">
                        <li>
        ...
        <div class="history-card">
            <div class="history-header">
                ...
                <h3><?php echo e(auth()->user()->isSeller() ? 'Ringkasan Order Selesai' : 'Riwayat Transaksi'); ?></h3>
            </div>
            <div class="history-body">
                ...
                <?php elseif(isset($transactions) && $transactions->count() > 0): ?>
                <div class="transaction-list">
                    ...
                    <div class="transaction-item">
                        ...
                        <div class="transaction-details">
                            ...
                            <div class="transaction-desc"><?php echo e($transaction->description); ?></div>
                        </div>
                        <div class="transaction-meta">
                            <div class="transaction-amount <?php echo e($transaction->type === 'topup' ? 'positive' : 'negative'); ?>">
                                <?php echo e($transaction->type === 'topup' ? '+' : '-'); ?>Rp <?php echo e(number_format($transaction->amount, 0, ',', '.')); ?>

                            </div>
                            <div class="transaction-date"><?php echo e($transaction->created_at->format('M d, H:i')); ?></div>
                            <span class="transaction-status <?php echo e($transaction->status); ?>"><?php echo e(ucfirst($transaction->status)); ?></span>
                        </div>
                    </div>
                ...
                <div class="pagination-wrapper">
                    <div class="pagination-info">
                        Menampilkan <?php echo e($transactions->firstItem()); ?> hingga <?php echo e($transactions->lastItem()); ?> dari <?php echo e($transactions->total()); ?> hasil
                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp5\htdocs\JajanGaming1\resources\views/wallet/index.blade.php ENDPATH**/ ?>