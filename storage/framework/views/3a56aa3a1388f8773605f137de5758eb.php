<?php $__env->startSection('title', 'Seller Dashboard - JajanGaming'); ?>
...
<div class="dashboard-wrapper">
    ...
    <aside class="dashboard-sidebar" id="dashboardSidebar">
        ...
        <nav class="sidebar-menu">
            ...
            <a href="<?php echo e(route('seller.dashboard')); ?>" class="menu-item active">
    ...
    <main class="dashboard-main">
        ...
        <div class="dashboard-header">
            <div class="header-left">
                ...
                <p class="header-subtitle">Selamat datang kembali, <?php echo e($user->name); ?>! Berikut adalah ringkasan penjualan Anda.</p>
            </div>
        ...
        <div class="financial-cards-section">
            <div class="financial-cards-grid">
                <a href="<?php echo e(route('seller.wallet')); ?>" class="financial-card financial-card-revenue" style="text-decoration: none; color: inherit;">
                ...
                <a href="<?php echo e(route('seller.wallet')); ?>" class="financial-card financial-card-wallet" style="text-decoration: none; color: inherit;">
                    <div class="financial-header">
                        <div class="financial-icon">
                            <i class="fas fa-wallet"></i>
                        </div>
                    ...
                    <div class="financial-amount">
                        <h2>Rp <?php echo e(number_format($seller->wallet_balance ?? 0, 0, ',', '.')); ?></h2>
                    </div>
                    <div class="financial-footer">
                        <span class="financial-trend">
        ...
        <div class="seller-stats-section">
            <div class="seller-stats-grid">
                <!-- Total Products -->
                <a href="<?php echo e(route('seller.products.index')); ?>" class="seller-stat-card seller-stat-products">
                ...
                <!-- Total Orders -->
                <a href="<?php echo e(route('seller.orders.index')); ?>" class="seller-stat-card seller-stat-orders">
                    <div class="seller-stat-icon-wrapper">
                        <i class="fas fa-shopping-bag"></i>
                    </div>
                    <div class="seller-stat-content">
                ...
                <div class="seller-stat-card seller-stat-rating">
                    ...
                    <div class="seller-stat-content">
                        <h3><?php echo e(number_format($stats['average_rating'], 1)); ?></h3>
                        <p>Rating Rata-rata</p>
                        <small><?php echo e(number_format($stats['total_ratings'])); ?> ulasan</small>
                    </div>
                </div>
                ...
                <div class="seller-stat-card seller-stat-satisfaction">
                    ...
                    <div class="seller-stat-content">
                        <h3><?php echo e(number_format($stats['customer_satisfaction'], 1)); ?>%</h3>
                ...
                <div class="seller-stat-card seller-stat-customers">
                    ...
                    <div class="seller-stat-content">
                        <h3><?php echo e(number_format($stats['unique_customers'])); ?></h3>
                        <p>Pelanggan Unik</p>
                    </div>
                </div>
                ...
                <div class="seller-stat-card seller-stat-avg-order">
                    ...
                    <div class="seller-stat-content">
                        <h3>Rp <?php echo e(number_format($stats['avg_order_value'], 0, ',', '.')); ?></h3>
        ...
        <div class="order-summary-section">
            <div class="order-summary-grid">
                ...
                <div class="order-summary-card order-completed">
                    ...
                    <div>
                        <h4><?php echo e(number_format($stats['completed_orders'])); ?></h4>
                        <span>Selesai</span>
                    </div>
                </div>
                <div class="order-summary-card order-cancelled">
                    ...
                    <div>
                        <h4><?php echo e(number_format($stats['cancelled_orders'])); ?></h4>
        ...
        <div class="seller-charts-grid">
            <div class="seller-chart-card seller-chart-large">
                <div class="seller-chart-header">
                    ...
                    <span class="seller-chart-badge">Tahun <?php echo e(date('Y')); ?></span>
                </div>
        ...
        <div class="tables-grid">
            ...
            <div class="data-card">
                <div class="data-header">
                    ...
                    <a href="<?php echo e(route('seller.orders.index')); ?>" class="view-all-btn">Lihat Semua <i class="fas fa-arrow-right"></i></a>
                </div>
                <div class="data-body">
            ...
            <div class="data-card">
                <div class="data-header">
                    ...
                    <a href="<?php echo e(route('seller.products.index')); ?>" class="view-all-btn">Lihat Semua <i class="fas fa-arrow-right"></i></a>
                </div>
                <div class="data-body">
                ...
                <div class="performance-info-card">
                    ...
                    <div class="performance-body">
                        <div class="top-products-mini">
                            <?php $__empty_1 = true; $__currentLoopData = $top_products->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div class="top-product-mini-item">
                                <span class="mini-rank">#<?php echo e($index + 1); ?></span>
                                <div class="mini-product-info">
                                    <h6><?php echo e(Str::limit($product->name, 20)); ?></h6>
                                    <span><?php echo e(number_format($product->sales_count)); ?> terjual</span>
                                </div>
                                <span class="mini-rating">
                                    <i class="fas fa-star"></i> <?php echo e(number_format($product->rating, 1)); ?>
        ...
        <div class="quick-actions-section">
            ...
            <div class="actions-grid">
                <a href="<?php echo e(route('seller.products.create')); ?>" class="action-card add-product">
                    <i class="fas fa-plus-circle"></i>
                    <span>Tambah Produk</span>
                </a>
                <a href="<?php echo e(route('seller.products.index')); ?>" class="action-card manage-products">
                    <i class="fas fa-boxes"></i>
                    <span>Kelola Produk</span>
                </a>
                <a href="<?php echo e(route('seller.orders.index')); ?>" class="action-card view-orders">
                    <i class="fas fa-clipboard-list"></i>
                    <span>Lihat Pesanan</span>
                </a>
                <a href="<?php echo e(route('seller.wallet')); ?>" class="action-card wallet">
                    <i class="fas fa-wallet"></i>
                    <span>Pendapatan</span>
                </a>
            </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (productsByGameCtx) {
        const productsByGameData = <?php echo json_encode($productsByGameType, 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp5\htdocs\JajanGaming1\resources\views/seller/dashboard.blade.php ENDPATH**/ ?>