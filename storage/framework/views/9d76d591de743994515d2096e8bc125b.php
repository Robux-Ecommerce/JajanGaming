...
<?php $__env->startSection('title', 'Register - JajanGaming'); ?>
    ...
    <div class="auth-container">
        ...
        <div class="auth-left">
            <div class="auth-form-wrapper">
                ...
                <form method="POST" action="<?php echo e(route('register')); ?>" class="auth-form" id="registerForm">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="role-options">
                            <div class="role-option">
                                <input type="radio" id="user" name="role" value="user"
                                    <?php echo e(old('role', 'user') == 'user' ? 'checked' : ''); ?> required>
                            ...
                            <div class="role-option">
                                <input type="radio" id="seller" name="role" value="seller"
                                    <?php echo e(old('role') == 'seller' ? 'checked' : ''); ?>>
        ...
        <div class="auth-right">
            <img src="<?php echo e(asset('img/gambar 3.jpg')); ?>" alt="Gaming" class="auth-bg-image">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp5\htdocs\JajanGaming1\resources\views/auth/register.blade.php ENDPATH**/ ?>