<?php $__env->startSection('title', isset($selectedSeller) ? $selectedSeller->name . ' - Produk - JajanGaming' : 'Kelola Produk - JajanGaming'); ?>
...
<div style="display: flex; min-height: calc(100vh - 80px);">
    <?php echo $__env->make('partials.sidebar', ['sidebarTitle' => 'Products'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    
    <!-- Main Content -->
    <div style="flex: 1; overflow-y: auto;">
        <div class="products-page">
            <?php if(isset($selectedSeller)): ?>
                ...
                <div class="page-header">
                    ...
                    <div class="header-actions">
                        <?php if($user->isAdmin()): ?>
                        <a href="<?php echo e(route('admin.products')); ?>" class="btn-back">
                ...
                <div class="selected-seller-bar">
                    <div class="seller-avatar">
                        <?php if($selectedSeller->profile_photo): ?>
                            <img src="<?php echo e(asset('storage/' . $selectedSeller->profile_photo)); ?>" alt="<?php echo e($selectedSeller->name); ?>">
                        <?php else: ?>
                            <i class="fas fa-user"></i>
                        <?php endif; ?>
                    </div>
                    <div>
                        <h4><?php echo e($selectedSeller->name); ?></h4>
                        <p><?php echo e($products->total()); ?> produk • <?php echo e($selectedSeller->email); ?></p>
                    </div>
                </div>
                    ...
                    <div class="product-card">
                        <div class="product-image">
                            ...
                            <?php else: ?>
                                ...
                                ?>
                                <img src="<?php echo e(asset($fallback)); ?>" alt="Random Product Image">
                            <?php endif; ?>
                            <span class="product-status <?php echo e($product->is_active ? 'active' : 'inactive'); ?>">
                                <?php echo e($product->is_active ? 'Aktif' : 'Nonaktif'); ?>

                            </span>
                        </div>
                        <div class="product-body">
                            <h4 class="product-name" title="<?php echo e($product->name); ?>"><?php echo e($product->name); ?></h4>
                            <p class="product-type"><?php echo e($product->game_type ?? 'Roblox'); ?></p>
                            <div class="product-meta">
                                <span class="product-price">Rp <?php echo e(number_format($product->price, 0, ',', '.')); ?></span>
                                <span class="product-sales"><?php echo e($product->sales_count ?? 0); ?> terjual</span>
                            </div>
                            <div class="product-actions">
                                <a href="<?php echo e(route('admin.products.edit', $product->id)); ?>" class="btn-edit">
                                    <i class="fas fa-edit"></i> Edit
                                </a>
                                <form action="<?php echo e(route('admin.products.destroy', $product->id)); ?>" method="POST" style="flex: 1;" onsubmit="return confirm('Hapus produk ini?')">
                                    <?php echo csrf_field(); ?>
                ...
                <div class="pagination-wrapper">
                    <?php echo e($products->appends(['seller_id' => $selectedSeller->id])->links()); ?>
            ...
            <?php else: ?>
                ...
                <div class="filter-bar">
                    ...
                    <div class="stats-pills">
                        <div class="stat-pill">
                            ...
                            <strong><?php echo e($sellers->count()); ?></strong> Penjual
                        </div>
                        <div class="stat-pill">
                            <i class="fas fa-cube"></i>
                            <strong><?php echo e($sellers->sum('total_products')); ?></strong> Produk
                        </div>
                        <div class="stat-pill">
                            <i class="fas fa-shopping-cart"></i>
                            <strong><?php echo e($sellers->sum('total_sales')); ?></strong> Penjualan
                        </div>
                    </div>
                </div>
                ...
                <div class="sellers-table">
                    ...
                    <div id="sellersContainer">
                        ...
                        <div class="seller-row" data-name="<?php echo e(strtolower($seller->name)); ?>" onclick="window.location.href='<?php echo e(route('admin.products', ['seller_id' => $seller->id])); ?>'">
                            <div class="seller-info">
                                <div class="seller-avatar">
                                    <?php if($seller->profile_photo): ?>
                                        <img src="<?php echo e(asset('storage/' . $seller->profile_photo)); ?>" alt="<?php echo e($seller->name); ?>">
                                    <?php else: ?>
                                        <i class="fas fa-user"></i>
                                    <?php endif; ?>
                                </div>
                            ...
                            <div class="seller-stat products"><?php echo e($seller->total_products); ?></div>
                            <div class="seller-stat sales"><?php echo e($seller->total_sales); ?></div>
                            <div>
                                <a href="<?php echo e(route('admin.products', ['seller_id' => $seller->id])); ?>" class="btn-view" onclick="event.stopPropagation();">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp5\htdocs\JajanGaming1\resources\views/admin/products/index.blade.php ENDPATH**/ ?>