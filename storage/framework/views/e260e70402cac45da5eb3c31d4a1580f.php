<?php $__env->startSection('title', 'Login - JajanGaming'); ?>
...
<div class="auth-container">
    <div class="auth-left">
        <div class="auth-form-wrapper">
            ...
            <form method="POST" action="<?php echo e(route('login')); ?>" class="auth-form" id="loginForm">
                <?php echo csrf_field(); ?>
...
<script>
    ...
    async function fetchStats() {
        try {
            const response = await fetch('<?php echo e(route("api.stats")); ?>');
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp5\htdocs\JajanGaming1\resources\views/auth/login.blade.php ENDPATH**/ ?>