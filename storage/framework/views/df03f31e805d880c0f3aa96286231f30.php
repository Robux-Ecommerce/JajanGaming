<?php $__env->startSection('title', 'Admin Dashboard - JajanGaming'); ?>
    ...
    <aside class="dashboard-sidebar" id="dashboardSidebar">
        ...
        <div class="sidebar-user">
            <?php if($user->profile_photo): ?>
                <img src="<?php echo e(asset('storage/' . $user->profile_photo)); ?>" alt="Profile" class="sidebar-avatar">
            <?php else: ?>
            ...
            <div class="sidebar-user-info">
                ...
                <span class="user-role"><?php echo e($user->isAdmin() ? 'Administrator' : ($user->isSeller() ? 'Penjual' : 'Pelanggan')); ?></span>
            </div>
        </div>
        ...
        <nav class="sidebar-menu">
            ...
            <a href="<?php echo e(route('admin.orders')); ?>" class="menu-item">
                ...
                <?php if($stats['pending_orders'] > 0): ?>
                    <span class="menu-badge"><?php echo e($stats['pending_orders']); ?></span>
                <?php endif; ?>
            </a>
            <?php if($user->isAdmin()): ?>
    ...
    <main class="dashboard-main">
        ...
        <div class="dashboard-header">
            <div class="header-left">
                <h1>
                    <i class="fas fa-tachometer-alt"></i>
                    <?php echo e($user->isAdmin() ? 'Dasbor Admin' : ($user->isSeller() ? 'Dasbor Penjual' : 'Dasbor Pelanggan')); ?>

                </h1>
                <p class="header-subtitle"><?php echo e($user->isAdmin() ? 'Selamat datang kembali, ' . $user->name . '! Berikut adalah ringkasan Anda.' : ($user->isSeller() ? 'Selamat datang kembali, ' . $user->name . '! Berikut adalah ringkasan penjualan Anda.' : 'Selamat datang kembali, ' . $user->name . '! Berikut adalah ringkasan belanja Anda.')); ?></p>
            </div>
        ...
        <div class="financial-cards-grid">
            <a href="<?php echo e(route('admin.transactions')); ?>" class="financial-card financial-card-revenue" style="text-decoration: none; color: inherit;">
                ...
                <div class="financial-amount">
                    <h2>Rp <?php echo e(number_format($stats['total_revenue'], 0, ',', '.')); ?></h2>
                </div>
            ...
            <?php if($user->isAdmin()): ?>
            <a href="<?php echo e(route('admin.wallet.index')); ?>" class="financial-card financial-card-wallet" style="text-decoration: none; color: inherit;">
                <div class="financial-header">
                    <div class="financial-icon">
                        <i class="fas fa-wallet"></i>
                    </div>
                ...
                <div class="financial-amount">
                    <h2>Rp <?php echo e(number_format($stats['admin_wallet_balance'] ?? 0, 0, ',', '.')); ?></h2>
                </div>
                <div class="financial-footer">
                    <span class="financial-trend">
            ...
            <div class="financial-card financial-card-seller">
                ...
                <div class="financial-amount">
                    <h2>Rp <?php echo e(number_format($stats['total_revenue'] ?? 0, 0, ',', '.')); ?></h2>
                </div>
                <div class="financial-footer">
                    <span class="financial-trend">
        ...
        <div class="stats-grid">
            ...
            <div class="stat-card stat-primary">
                ...
                <div class="stat-content">
                    <h3><?php echo e(number_format($stats['total_products'])); ?></h3>
                    <p>Total Produk</p>
                </div>
            ...
            <div class="stat-card" style="border-left: 4px solid #c9a856;">
                ...
                <div class="stat-content">
                    <h3><?php echo e(number_format($stats['pending_orders'] ?? 0)); ?></h3>
        ...
        <div class="stats-grid">
            ...
            <div class="stat-card stat-info">
                ...
                <div class="stat-content">
                    <h3><?php echo e($stats['total_orders'] > 0 ? round(($stats['completed_orders'] / $stats['total_orders']) * 100, 1) : 0); ?>%</h3>
            ...
            <div class="stat-card stat-success">
                ...
                <div class="stat-content">
                    <h3>Rp <?php echo e($stats['total_orders'] > 0 ? number_format($stats['total_revenue'] / $stats['total_orders'], 0, ',', '.') : 0); ?></h3>
            ...
            <div class="stat-card" style="border-left: 4px solid #c47070;">
                ...
                <div class="stat-content">
                    <h3><?php echo e($stats['total_orders'] > 0 ? round(($stats['cancelled_orders'] / $stats['total_orders']) * 100, 1) : 0); ?>%</h3>
        ...
        <div class="order-status-grid">
            <div class="order-status-card pending">
                ...
                <div class="status-content">
                    <span class="status-count"><?php echo e(number_format($stats['pending_orders'])); ?></span>
            ...
            <div class="order-status-card completed">
                ...
                <div class="status-content">
                    <span class="status-count"><?php echo e(number_format($stats['completed_orders'])); ?></span>
            ...
            <div class="order-status-card cancelled">
                ...
                <div class="status-content">
                    <span class="status-count"><?php echo e(number_format($stats['cancelled_orders'])); ?></span>
        ...
        <div class="tables-grid">
            ...
            <div class="data-card">
                <div class="data-header">
                    ...
                    <a href="<?php echo e(route('admin.orders')); ?>" class="view-all-btn">Lihat Semua <i class="fas fa-arrow-right"></i></a>
                </div>
                <div class="data-body">
                        ...
                        <table class="dashboard-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><span class="amount">Rp <?php echo e(number_format($order->total_amount, 0, ',', '.')); ?></span></td>
                                    <td>
                                    ...
                                    <td><span class="date"><?php echo e($order->created_at->format('d M Y')); ?></span></td>
                                </tr>
            ...
            <div class="data-card">
                <div class="data-header">
                    ...
                    <a href="<?php echo e(route('admin.products')); ?>" class="view-all-btn">Lihat Semua <i class="fas fa-arrow-right"></i></a>
                </div>
                <div class="data-body">
                    <div class="top-products-list">
                        ...
                        <div class="product-item">
                            <span class="product-rank">#<?php echo e($index + 1); ?></span>
                            <img src="<?php echo e(asset('img/' . $product->image)); ?>" alt="<?php echo e($product->name); ?>" class="product-image">
                            <div class="product-info">
                                <h6><?php echo e($product->name); ?></h6>
                                <span class="product-sales"><?php echo e(number_format($product->sales_count)); ?> sold</span>
                            </div>
                    ...
                    <div class="quick-stats-list">
                        <div class="quick-stat-item">
                            ...
                            <div class="stat-details">
                                <span class="stat-value"><?php echo e($stats['total_orders'] > 0 ? round(($stats['completed_orders'] / $stats['total_orders']) * 100, 1) : 0); ?>%</span>
                        ...
                        <div class="quick-stat-item">
                            ...
                            <div class="stat-details">
                                <span class="stat-value">Rp <?php echo e($stats['total_orders'] > 0 ? number_format($stats['total_revenue'] / $stats['total_orders'], 0, ',', '.') : 0); ?></span>
                        ...
                        <div class="quick-stat-item">
                            ...
                            <div class="stat-details">
                                <span class="stat-value"><?php echo e($top_products->count() > 0 ? Str::limit($top_products->first()->name, 15) : 'N/A'); ?></span>
                        ...
                        <div class="quick-stat-item">
                            ...
                            <div class="stat-details">
                                <span class="stat-value"><?php echo e($stats['total_orders'] > 0 ? round(($stats['cancelled_orders'] / $stats['total_orders']) * 100, 1) : 0); ?>%</span>
        ...
        <div class="quick-actions-section">
            ...
            <div class="actions-grid">
                <a href="<?php echo e(route('admin.products.create')); ?>" class="action-card add-product">
                    <i class="fas fa-plus-circle"></i>
                    <span>Add Product</span>
                </a>
                <a href="<?php echo e(route('admin.products')); ?>" class="action-card manage-products">
                    <i class="fas fa-boxes"></i>
                    <span>Manage Products</span>
                </a>
                <a href="<?php echo e(route('admin.orders')); ?>" class="action-card view-orders">
                    <i class="fas fa-clipboard-list"></i>
                    <span>View Orders</span>
                </a>
                <?php if($user->isAdmin()): ?>
                <a href="<?php echo e(route('admin.users')); ?>" class="action-card manage-users">
                    <i class="fas fa-user-friends"></i>
                    <span>Manage Users</span>
                </a>
                <?php else: ?>
                <a href="<?php echo e(route('wallet.index')); ?>" class="action-card wallet">
                    <i class="fas fa-wallet"></i>
                    <span>My Wallet</span>
                </a>
                <?php endif; ?>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const monthLabels = <?php echo json_encode($months, 15, 512) ?>;
    const revenueData = <?php echo json_encode(array_values($revenueSeries), 15, 512) ?>;
    const ordersData = <?php echo json_encode(array_values($ordersSeries), 15, 512) ?>;
    ...
    if (statusCtx) {
        new Chart(statusCtx, {
            ...
            data: {
                ...
                datasets: [{
                    data: [<?php echo e($stats['pending_orders']); ?>, <?php echo e($stats['completed_orders']); ?>, <?php echo e($stats['cancelled_orders']); ?>],
                    backgroundColor: [
                        'rgba(201, 168, 86, 0.7)',
                        'rgba(92, 184, 144, 0.7)',
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp5\htdocs\JajanGaming1\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>