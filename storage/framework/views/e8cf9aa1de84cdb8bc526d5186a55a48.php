...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'JajanGaming - Top Up Robux Roblox'); ?></title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
    <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700&display=swap" rel="stylesheet">
    <style>
        :root {
            --primary-color: #64a0b4;
            --primary-soft: rgba(100, 160, 180, 0.9);
            --primary-glow: rgba(100, 160, 180, 0.3);
            ...
            --gradient-primary: linear-gradient(135deg, rgba(100, 160, 180, 0.9) 0%, rgba(80, 140, 165, 0.9) 100%);
            --gradient-secondary: linear-gradient(135deg, #1e2a3a 0%, #1a2535 100%);
        ...
        * {
        ...
        .navbar::after {
            ...
            background: linear-gradient(to right,
                    transparent 0%,
                    transparent 20%,
                    rgba(100, 160, 180, 0.2) 30%,
                    rgba(100, 160, 180, 0.4) 45%,
                    rgba(100, 160, 180, 0.5) 50%,
                    rgba(100, 160, 180, 0.4) 55%,
                    rgba(100, 160, 180, 0.2) 70%,
                    transparent 80%,
        ...
        @media (min-width: 577px) {
            ...
            /* Show sidebar for user pages on desktop */
        ...
        .sidebar-quick-action::before {
            ...
            width: 100%;
            height: 100%;
            background: linear-gradient(90deg, transparent, rgba(100, 160, 180, 0.08), transparent);
        ...
        .sidebar-quick-action:hover {
            background: rgba(100, 160, 180, 0.12);
            transform: translateX(5px);
            box-shadow: 0 4px 12px rgba(100, 160, 180, 0.15);
        }
        ...
        #notificationBadge {
            ...
            background: linear-gradient(135deg, #c47070 0%, #b05858 100%) !important;
            border: 2px solid #1e2a3a !important;
        ...
        .navbar-nav .nav-link:hover {
            background-color: rgba(100, 160, 180, 0.12);
            color: var(--primary-color);
        }
        ...
        .navbar-brand:hover {
            color: rgba(130, 180, 200, 0.95) !important;
        }
        ...
        @media (max-width: 576px) {
            .sidebar-toggle {
                ...
                height: 44px;
                background: #1e2a3a;
                border: 1px solid rgba(100, 160, 180, 0.2) !important;
                z-index: 1051;
                align-items: center;
                justify-content: center;
                padding: 0 !important;
            ...
            .sidebar-toggle:hover {
                background: #253040;
                border-color: rgba(100, 160, 180, 0.4) !important;
                color: var(--primary-color);
            }
        ...
        @media (max-width: 1024px) and (min-width: 769px) {
            ...
            .nav-link.active {
                background: rgba(100, 160, 180, 0.2) !important;
                color: #ffffff !important;
            }
        ...
        .wallet-balance {
            background: linear-gradient(135deg, rgba(100, 160, 180, 0.9) 0%, rgba(80, 140, 165, 0.85) 100%);
            color: white;
            padding: 0.5rem 1rem;
            border-radius: 16px;
            font-size: 0.85rem;
        ...
        .btn-primary:hover {
            transform: translateY(-2px);
            box-shadow: 0 6px 20px rgba(100, 160, 180, 0.25);
        }
        ...
        /* ===================================================================
           HERO WRAPPER - SOFT GAMING STYLE
        =================================================================== */
        .hero-wrapper {
            display: flex;
            gap: 24px;
            ...
            max-width: 100%;
            align-items: stretch;
            background: linear-gradient(135deg, #1e2a3a 0%, #1a2535 50%, #162030 100%);
            border-radius: 20px;
            position: relative;
            overflow: hidden;
            width: 100%;
        ...
        .hero-wrapper::before {
            ...
            height: 200%;
            background: 
                radial-gradient(circle at 20% 80%, rgba(100, 150, 180, 0.08) 0%, transparent 50%),
                radial-gradient(circle at 80% 20%, rgba(120, 140, 200, 0.06) 0%, transparent 50%),
                radial-gradient(circle at 40% 40%, rgba(150, 160, 180, 0.04) 0%, transparent 40%);
        ...
        .particle-1 { top: 10%; left: 5%; animation-delay: 0s; font-size: 1.5rem; }
        .particle-2 { top: 20%; right: 10%; animation-delay: 3s; font-size: 1.4rem; }
        .particle-3 { top: 60%; left: 3%; animation-delay: 6s; }
        .particle-4 { top: 70%; right: 5%; animation-delay: 9s; font-size: 1rem; }
        .particle-5 { top: 40%; left: 8%; animation-delay: 12s; font-size: 1.3rem; }
        .particle-6 { top: 85%; right: 15%; animation-delay: 15s; }
        ...
        /* Hero Slider Card (Left) - Soft Style */
        .hero-slider-card {
            position: relative;
            flex: 1;
            min-height: 500px;
            ...
            box-shadow: 
                ...
                0 0 30px rgba(100, 160, 180, 0.08);
            transition: all 0.4s cubic-bezier(0.4, 0, 0.2, 1);
            z-index: 1;
            width: 100%;
        }
        ...
        .hero-slider-card:hover {
            ...
            box-shadow: 
                ...
                0 0 40px rgba(100, 160, 180, 0.12);
        }
        
        .hero-slider-card .hero-slider {
            position: absolute;
            inset: 0;
            width: 100%;
            height: 100%;
        ...
        .hero-slider-card .dark-overlay {
            position: absolute;
            inset: 0;
            background: 
                linear-gradient(135deg, rgba(26, 26, 46, 0.9) 0%, rgba(26, 26, 46, 0.6) 40%, transparent 70%),
                linear-gradient(to top, rgba(26, 26, 46, 0.8) 0%, transparent 50%);
            z-index: 2;
        }
        
        .hero-slider-card .hero-content {
            position: absolute;
            bottom: 0;
            left: 0;
            right: 40%;
        ...
        .hero-badge {
            ...
            align-items: center;
            gap: 10px;
            background: linear-gradient(135deg, rgba(100, 160, 180, 0.9) 0%, rgba(80, 130, 160, 0.9) 100%);
            color: white;
            padding: 10px 20px;
            border-radius: 30px;
            font-size: 0.75rem;
        ...
        @keyframes badgeGlow {
            ...
            50% { 
                box-shadow: 0 4px 20px rgba(100, 160, 180, 0.35);
            }
        }
        ...
        .hero-slider-card .hero-title .highlight-text {
            background: linear-gradient(135deg, #64b5c6 0%, #90cad7 50%, #a8d8e0 100%);
            -webkit-background-clip: text;
            -webkit-text-fill-color: transparent;
            background-clip: text;
            position: relative;
        ...
        .hero-slider-card .hero-title .highlight-text::after {
            content: '';
            position: absolute;
            bottom: -5px;
            left: 0;
            width: 100%;
            height: 3px;
            background: linear-gradient(135deg, rgba(100, 181, 198, 0.6) 0%, rgba(168, 216, 224, 0.4) 100%);
            border-radius: 2px;
        }
        ...
        .hero-slider-card .hero-description {
            font-size: 1.05rem;
            color: rgba(255, 255, 255, 0.9);
            line-height: 1.7;
        ...
        .hero-slider-card .hero-buttons {
            display: flex;
            gap: 14px;
            flex-wrap: wrap;
        }
        
        .hero-slider-card .btn-hero-primary {
            background: linear-gradient(135deg, rgba(100, 160, 180, 0.95) 0%, rgba(80, 140, 170, 0.95) 100%);
            color: #ffffff;
            border: none;
            padding: 14px 28px;
            border-radius: 10px;
            ...
            font-size: 0.95rem;
            transition: all 0.3s ease;
            box-shadow: 0 4px 15px rgba(80, 140, 170, 0.3);
            position: relative;
            overflow: hidden;
        }
        
        .hero-slider-card .btn-hero-primary::before {
            content: '';
            position: absolute;
            top: 0;
            left: -100%;
        ...
        .hero-slider-card .btn-hero-primary:hover::before {
            left: 100%;
        }
        
        .hero-slider-card .btn-hero-primary:hover {
            transform: translateY(-3px);
            box-shadow: 0 8px 25px rgba(80, 140, 170, 0.4);
            background: linear-gradient(135deg, rgba(110, 170, 190, 0.95) 0%, rgba(90, 150, 180, 0.95) 100%);
        }
        
        .hero-slider-card .btn-hero-secondary {
            background: rgba(255, 255, 255, 0.1);
            color: #ffffff;
            border: 2px solid rgba(255, 255, 255, 0.3);
            padding: 14px 28px;
        ...
        .hero-slider-card .btn-hero-secondary:hover {
            background: rgba(255, 255, 255, 0.15);
            border-color: rgba(100, 160, 180, 0.6);
            transform: translateY(-3px);
            box-shadow: 0 6px 20px rgba(100, 160, 180, 0.15);
        }
        
        /* Thumbnail List - Soft Gaming Style */
        .hero-thumbnails-list {
            display: flex;
            flex-direction: column;
            gap: 8px;
            width: 250px;
            flex-shrink: 0;
            z-index: 1;
            background: linear-gradient(135deg, rgba(30, 40, 60, 0.7) 0%, rgba(25, 35, 55, 0.6) 100%);
            border-radius: 16px;
            padding: 18px;
        ...
        .hero-thumbnails-list::before {
            ...
            margin-bottom: 12px;
            padding-bottom: 10px;
            border-bottom: 1px solid rgba(100, 160, 180, 0.25);
        }
        ...
        .hero-thumb-item:hover::before {
            opacity: 1;
        }
        
        .hero-thumb-item.active {
            background: rgba(100, 160, 180, 0.12);
            border: 1px solid rgba(100, 160, 180, 0.35);
            position: relative;
        }
        
        .hero-thumb-item.active::after {
            display: none;
        }
        
        .hero-thumb-item.active {
            box-shadow: 0 4px 15px rgba(100, 160, 180, 0.15);
            transform: translateX(-5px);
        }
        ...
        .hero-thumb-item.active img {
            transform: scale(1.05);
            border-color: rgba(100, 160, 180, 0.4);
            box-shadow: 0 3px 10px rgba(100, 160, 180, 0.2);
        }
        
        .hero-thumb-item .thumb-title {
        ...
        .hero-thumb-item:hover .thumb-title,
        .hero-thumb-item.active .thumb-title {
            color: rgba(255, 255, 255, 0.95);
        }
        
        /* Play indicator for active */
        .hero-thumb-item.active .thumb-title::before {
            content: '• ';
            color: rgba(140, 190, 210, 0.9);
            font-size: 0.8rem;
        }
        
        /* Responsive for Hero Wrapper */
        ...
        @media (max-width: 992px) {
            ...
            .hero-thumbnails-list::-webkit-scrollbar {
                display: none;
            }
        ...
        .hero-section {
            ...
            overflow: visible;
            border-radius: 24px;
            background: linear-gradient(135deg, rgba(10, 10, 10, 0.95) 0%, rgba(15, 52, 96, 0.9) 100%);
        ...
        .hero-slide:nth-child(1) {
            background-image: url('<?php echo e(asset('img/rbg1.jpg')); ?>');
        }

        .hero-slide:nth-child(2) {
            background-image: url('<?php echo e(asset('img/rbg2.jpg')); ?>');
        }

        .hero-slide:nth-child(3) {
            background-image: url('<?php echo e(asset('img/rbg3.jpg')); ?>');
        }

        .hero-slide:nth-child(4) {
            background-image: url('<?php echo e(asset('img/rbg4.jpg')); ?>');
        }

        .hero-slide:nth-child(5) {
            background-image: url('<?php echo e(asset('img/rbg5.jpg')); ?>');
        }

        .hero-slide:nth-child(6) {
            background-image: url('<?php echo e(asset('img/rbg6.jpg')); ?>');
        }
        ...
        /* ===================================================================
           BLUR GRADIENT - TOP & BOTTOM (REMOVED FOR CLEANER LOOK)
        =================================================================== */
        .hero-slider::before,
        .hero-slider::after {
            content: "";
        ...
        .btn-hero-primary:hover {
            background: linear-gradient(135deg, #00e5ff 0%, #00b9ff 100%);
        ...
        .hero-section:hover .hero-thumbnails-container {
            background: rgba(0, 0, 0, 0.4);
            border-color: rgba(0, 212, 170, 0.25);
            box-shadow: 0 8px 32px rgba(0, 212, 170, 0.15), 0 8px 32px rgba(0, 0, 0, 0.4);
        }
        ...
        .hero-thumbnail .thumbnail-overlay {
            position: absolute;
            inset: 0;
            background: rgba(0, 0, 0, 0.3);
            transition: all 0.3s ease;
        ...
        .hero-thumbnail.active .thumbnail-overlay {
            background: rgba(0, 212, 255, 0.1);
        }

        /* ===================================================================
           VERTICAL THUMBNAILS (Right Side - Epic Games Style - Very Small)
        =================================================================== */
        ...
        /* Overlay effect untuk thumbnail items */
        ...
        .hero-title {
            ...
            margin-bottom: 1rem;
            color: #ffffff;
            text-shadow: 0 2px 15px rgba(0, 0, 0, 0.6), 0 2px 20px rgba(0, 212, 255, 0.1);
            position: relative;
            z-index: 5;
            line-height: 1.35;
        ...
        .calculator-input:focus {
            ...
            box-shadow: inset 0 2px 6px rgba(0, 0, 0, 0.2), 0 0 0 3px rgba(100, 160, 180, 0.1);
        }
        ...
        .calculator-result {
            background: rgba(100, 160, 180, 0.1);
            border-left: 3px solid rgba(100, 160, 180, 0.5);
            border-radius: 10px;
        ...
        .btn-calculator-search {
            ...
            font-size: 0.9rem;
            transition: all 0.3s ease;
            box-shadow: 0 4px 15px rgba(80, 140, 165, 0.25);
            position: relative;
            overflow: hidden;
        ...
        .btn-calculator-search:hover {
            transform: translateY(-2px);
            box-shadow: 0 6px 20px rgba(80, 140, 165, 0.35);
            color: #ffffff;
            background: linear-gradient(135deg, rgba(110, 170, 190, 0.9) 0%, rgba(90, 150, 175, 0.9) 100%);
        }
        ...
        .product-image {
            height: 200px;
            background: linear-gradient(135deg, var(--bg-dark) 0%, var(--accent-color) 100%);
            display: flex;
            align-items: center;
            justify-content: center;
            position: relative;
        ...
        .quick-actions-section {
            background: linear-gradient(135deg, rgba(26, 35, 50, 0.85) 0%, rgba(22, 30, 45, 0.9) 100%);
            padding: 2rem 0;
            margin-top: -1.5rem;
            position: relative;
            z-index: 6;
        ...
        .robux-calculator-card,
        .search-filter-card {
            background: linear-gradient(135deg, rgba(30, 42, 58, 0.9) 0%, rgba(25, 35, 50, 0.85) 100%);
            border: 1px solid rgba(100, 160, 180, 0.15);
            border-radius: 16px;
            padding: 1.8rem;
            backdrop-filter: blur(12px);
        ...
        .robux-calculator-card::before,
        .search-filter-card::before {
            content: '';
            position: absolute;
            inset: 0;
            background: radial-gradient(circle at 100% 0%, rgba(100, 160, 180, 0.04), transparent 50%);
            pointer-events: none;
        }

        .robux-calculator-card:hover,
        ...
        /* Sidebar visible on all pages for mobile */
        /* No hiding of sidebar on dashboard anymore */
    </style>
    <?php echo $__env->yieldContent('styles'); ?>
</head>

<body <?php if(Request::routeIs('admin.dashboard')): ?> class="dashboard-page" <?php endif; ?>>
    <!-- Sidebar Overlay -->
    ...
    <div class="sidebar" id="sidebar">
            ...
            <?php if(auth()->guard()->check()): ?>
                <?php if(auth()->user()->isUser()): ?>
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('browse')); ?>">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('wallet.index')); ?>">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link sidebar-notification" href="<?php echo e(route('notifications.index')); ?>">
                                <i class="fas fa-bell"></i>
                                Notifications
                                <span class="badge sidebar-notification-badge notification-count-badge">0</span>
                            </a>
                        </li>
                    </ul>
                <?php elseif(auth()->user()->isAdmin()): ?>
                    ...
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link sidebar-quick-action" href="<?php echo e(route('admin.products.create')); ?>">
                                <i class="fas fa-plus"></i>
                                Add Product
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link sidebar-quick-action" href="<?php echo e(route('admin.products')); ?>">
                                <i class="fas fa-cube"></i>
                                Manage Products
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link sidebar-quick-action" href="<?php echo e(route('admin.orders')); ?>">
                                <i class="fas fa-shopping-cart"></i>
                                View Orders
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link sidebar-quick-action" href="<?php echo e(route('admin.users')); ?>">
                ...
                <?php elseif(auth()->user()->isSeller()): ?>
                    ...
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link sidebar-quick-action" href="<?php echo e(route('seller.products.create')); ?>">
                                <i class="fas fa-plus"></i>
                                Add Product
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link sidebar-quick-action" href="<?php echo e(route('seller.products.index')); ?>">
                                <i class="fas fa-cube"></i>
                                Manage Products
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link sidebar-quick-action" href="<?php echo e(route('seller.orders.index')); ?>">
                                <i class="fas fa-shopping-cart"></i>
                                View Orders
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link sidebar-quick-action" href="<?php echo e(route('seller.wallet')); ?>">
                                <i class="fas fa-wallet"></i>
                                My Wallet
                            </a>
                        </li>
        ...
        <?php if(auth()->guard()->check()): ?>
            <div class="sidebar-footer">
                <a href="<?php echo e(route('profile.index')); ?>" class="sidebar-user">
    ...
    <nav class="navbar navbar-expand-md navbar-dark">
        <div class="container d-flex">
            ...
            <div class="navbar-brand-center">
                <a href="<?php echo e(route('home')); ?>" style="text-decoration: none; color: #64a0b4; font-weight: 600; font-size: 1.2rem;">
                    JajanGaming
                </a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('sellers.index')); ?>">
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        <?php if(auth()->user()->isUser()): ?>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(route('wishlist.index')); ?>" style="color: #ff3c5a; transition: color 0.3s;">
                                    <i class="fas fa-heart me-1"></i>Wishlist
                                </a>
                            </li>
                        <?php elseif(auth()->user()->isSeller()): ?>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(route('seller.products.index')); ?>">
                                    <i class="fas fa-cube me-1"></i>Products
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(route('seller.orders.index')); ?>">
                ...
                <ul class="navbar-nav align-items-center">
                    <?php if(auth()->guard()->check()): ?>
                        <li class="nav-item me-3">
                            <a class="nav-link position-relative d-flex align-items-center" href="<?php echo e(route('notifications.index')); ?>"
                                id="notificationBell">
                                <i class="fas fa-bell"></i>
                                <span
                        ...
                        <?php if(auth()->user()->isUser()): ?>
                            <li class="nav-item me-3">
                                <a href="<?php echo e(route('wallet.index')); ?>" class="wallet-balance">
                                    <i class="fas fa-wallet"></i>
                                    Saldo: Rp <?php echo e(number_format(auth()->user()->wallet_balance, 0, ',', '.')); ?>

                                </a>
                            </li>
                        <?php elseif(auth()->user()->isSeller()): ?>
                            <li class="nav-item me-3">
                                <a href="<?php echo e(route('seller.wallet')); ?>" class="wallet-balance">
                                    <i class="fas fa-chart-line"></i>
                                    Pendapatan: Rp <?php echo e(number_format(auth()->user()->wallet_balance, 0, ',', '.')); ?>
                        ...
                        <?php elseif(auth()->user()->isAdmin()): ?>
                            <li class="nav-item me-3">
                                <a href="<?php echo e(route('wallet.index')); ?>" class="wallet-balance">
                                    ...
                                    Sistem: Rp <?php echo e(number_format(auth()->user()->wallet_balance, 0, ',', '.')); ?>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <?php if(auth()->user()->isUser()): ?>
                                    <li><a class="dropdown-item" href="<?php echo e(route('profile.index')); ?>"><i class="fas fa-user me-2"></i>Profil Saya</a></li>
                                    <li><a class="dropdown-item" href="<?php echo e(route('wallet.index')); ?>"><i class="fas fa-wallet me-2"></i>Saldo Saya</a></li>
                                    <li><a class="dropdown-item" href="<?php echo e(route('orders.index')); ?>"><i class="fas fa-receipt me-2"></i>Pesanan Saya</a></li>
                                    <li>
                                        <hr class="dropdown-divider">
                                    </li>
                                <?php elseif(auth()->user()->isSeller()): ?>
                                    <li><a class="dropdown-item" href="<?php echo e(route('seller.profile')); ?>"><i class="fas fa-user me-2"></i>Profil Saya</a></li>
                                    <li><a class="dropdown-item" href="<?php echo e(route('seller.wallet')); ?>"><i class="fas fa-chart-line me-2"></i>Pendapatan</a></li>
                                    <li><a class="dropdown-item" href="<?php echo e(route('seller.products.index')); ?>"><i class="fas fa-cube me-2"></i>Produk Saya</a></li>
                                    <li><a class="dropdown-item" href="<?php echo e(route('seller.orders.index')); ?>"><i class="fas fa-shopping-bag me-2"></i>Pesanan</a></li>
                                    <li><a class="dropdown-item" href="<?php echo e(route('seller.dashboard')); ?>"><i class="fas fa-tachometer-alt me-2"></i>Dasbor</a></li>
                                    <li><a class="dropdown-item" href="<?php echo e(route('seller.profile')); ?>"><i class="fas fa-cog me-2"></i>Pengaturan</a></li>
                                    <li>
                                        <hr class="dropdown-divider">
                                    </li>
                                <?php elseif(auth()->user()->isAdmin()): ?>
                                    <li><a class="dropdown-item" href="<?php echo e(route('admin.profile')); ?>"><i class="fas fa-user me-2"></i>Profil Saya</a></li>
                                    <li><a class="dropdown-item" href="<?php echo e(route('wallet.index')); ?>"><i class="fas fa-coins me-2"></i>Dompet Sistem</a></li>
                                    <li><a class="dropdown-item" href="<?php echo e(route('admin.dashboard')); ?>"><i class="fas fa-tachometer-alt me-2"></i>Dasbor</a></li>
                                    <li><a class="dropdown-item" href="<?php echo e(route('admin.users')); ?>"><i class="fas fa-users me-2"></i>Pengguna</a></li>
                                    <li><a class="dropdown-item" href="<?php echo e(route('admin.products')); ?>"><i class="fas fa-cube me-2"></i>Produk</a></li>
                                    <li><a class="dropdown-item" href="<?php echo e(route('admin.orders')); ?>"><i class="fas fa-shopping-bag me-2"></i>Pesanan</a></li>
                                    <li><a class="dropdown-item" href="<?php echo e(route('admin.transactions')); ?>"><i class="fas fa-exchange-alt me-2"></i>Transaksi</a></li>
                                    <li><a class="dropdown-item" href="<?php echo e(route('admin.profile')); ?>"><i class="fas fa-cog me-2"></i>Pengaturan</a></li>
                                    <li>
                                        <hr class="dropdown-divider">
                                    </li>
                                <?php endif; ?>
                    ...
                    <?php else: ?>
                        ...
                        <li class="nav-item">
                            <a class="btn btn-register" href="<?php echo e(route('register')); ?>">Register</a>
                        </li>
                    <?php endif; ?>
                </ul>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="<?php echo e(route('home')); ?>" class="text-white-50 text-decoration-none">Home</a></li>
                        <li><a href="<?php echo e(route('wallet.index')); ?>"
    ...
    <script>
        ...
        // Function to go to specific slide from thumbnail click
        goToHeroSlide = function(slideIndex) {
            console.log('🎯 goToHeroSlide called with index:', slideIndex);
            const slides = document.querySelectorAll('.hero-slide');
            const sliderCardSlides = document.querySelectorAll('.hero-slider-card .hero-slide');
            const targetSlides = sliderCardSlides.length > 0 ? sliderCardSlides : slides;
            ...
            if (slideIndex < 0 || slideIndex >= targetSlides.length) {
                console.error('❌ Invalid slide index:', slideIndex);
                return;
            }

            // Remove active from current slide
            targetSlides[currentSlide].classList.remove('active');
            console.log('➖ Removed active from slide', currentSlide + 1);
        ...
        updateThumbnailActive = function(slideIndex) {
            console.log('🎨 Updating thumbnail active state for index:', slideIndex);
            
            // Update horizontal thumbnails (if any)
            const horizontalThumbnails = document.querySelectorAll('.hero-thumbnail');
            if (horizontalThumbnails && horizontalThumbnails.length > 0) {
                horizontalThumbnails.forEach((thumb, index) => {
                    thumb.classList.remove('active');
                    if (index === slideIndex) {
                        thumb.classList.add('active');
                        console.log('✅ Set horizontal thumbnail', slideIndex + 1, 'as active');
                    }
                });
            }

            // Update vertical thumbnails (new layout)
            const verticalThumbnails = document.querySelectorAll('.hero-thumbnail-item');
            if (verticalThumbnails && verticalThumbnails.length > 0) {
                verticalThumbnails.forEach((thumb, index) => {
                    thumb.classList.remove('active');
                    if (index === slideIndex) {
                        thumb.classList.add('active');
                        console.log('✅ Set vertical thumbnail', slideIndex + 1, 'as active');
                    }
                });
            }
            
            // Update Epic Games style thumbnails (new layout)
            const epicThumbnails = document.querySelectorAll('.hero-thumb-item');
            if (epicThumbnails && epicThumbnails.length > 0) {
                epicThumbnails.forEach((thumb, index) => {
                    thumb.classList.remove('active');
                    if (index === slideIndex) {
                        thumb.classList.add('active');
                        console.log('✅ Set epic thumbnail', slideIndex + 1, 'as active');
                    }
                });
            }
        };
        ...
        console.log('   window.goToHeroSlide:', typeof window.goToHeroSlide);
        console.log('   window.updateThumbnailActive:', typeof window.updateThumbnailActive);
    ...
    .loader-spinner {
        width: 60px;
        height: 60px;
        border: 4px solid rgba(100, 160, 180, 0.2);
        border-top-color: #64a0b4;
        border-radius: 50%;
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Show loader on form submissions and link clicks
        ...
        // Show loader on link clicks (except external links and hash links)
        ...
        // Hide loader on AJAX requests completion
        if (window.axios) {
...
<?php /**PATH C:\xampp5\htdocs\JajanGaming1\resources\views/layouts/app.blade.php ENDPATH**/ ?>