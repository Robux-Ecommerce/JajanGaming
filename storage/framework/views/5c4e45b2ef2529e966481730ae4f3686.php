<?php $__env->startSection('title', 'Manage Transactions - JajanGaming'); ?>
...
<div style="display: flex; min-height: calc(100vh - 80px); background: linear-gradient(135deg, #0a1218 0%, #0f1a24 50%, #142130 100%);">
    <?php echo $__env->make('partials.sidebar', ['sidebarTitle' => 'Transactions'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            ...
            <div class="row mb-3">
                <div class="col-lg-3 col-md-6 mb-2">
                    <div class="stats-card total">
                        ...
                        <div class="stats-content">
                            ...
                            <h3><?php echo e($transactions->total()); ?></h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 mb-2">
                    <div class="stats-card success">
                        ...
                        <div class="stats-content">
                            <h6>Berhasil</h6>
                            <h3><?php echo e($transactions->where('status', 'success')->count()); ?></h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 mb-2">
                    <div class="stats-card warning">
                        ...
                        <div class="stats-content">
                            <h6>Pending</h6>
                            <h3><?php echo e($transactions->where('status', 'pending')->count()); ?></h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 mb-2">
                    <div class="stats-card danger">
                        ...
                        <div class="stats-content">
                            <h6>Gagal</h6>
                            <h3><?php echo e($transactions->where('status', 'failed')->count()); ?></h3>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp5\htdocs\JajanGaming1\resources\views/admin/transactions/index.blade.php ENDPATH**/ ?>