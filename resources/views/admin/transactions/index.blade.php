                                        ...
                                        <tr class="transaction-row">
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center gap-2">
                                                    ...
                                                    <div>
                                                        <div class="fw-600">{{ $transaction->user->name }}</div>
                                            ...
                                            <td>
                                                <div>
                                                    @if($transaction->type === 'topup')
                                                        ...
                                                        <br><small class="text-muted">Dari: {{ $transaction->payment_method === 'wallet' ? 'Dompet Internal' : 'Payment Gateway' }}</small>
                                                    @elseif($transaction->type === 'purchase')
                                                        <span class="transaction-type-purchase">
                                                            <i class="fas fa-shopping-cart me-1"></i>Pembelian Produk
                                                        </span>
                                                        <br><small class="text-muted">Order: {{ $transaction->order->id ?? 'N/A' }}</small>
                                                    @elseif($transaction->type === 'withdrawal')
                                                        <span class="transaction-type-withdrawal">
                                                            <i class="fas fa-arrow-down me-1"></i>Penarikan Dana
                                                        </span>
                                                    @else
                                                        <span class="transaction-type-other">{{ ucfirst($transaction->type) }}</span>
                                                    @endif
                                                </div>
                                            </td>
                                            <td>
