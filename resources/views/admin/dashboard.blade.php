        ...
        <div class="row">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        <h6 class="m-0 font-weight-bold text-primary">
                            {{ $user->isSeller() ? 'Dompet Penghasilan' : 'Recent Orders' }}</h6>
                        @if ($user->isSeller())
                        ...
                        @if ($user->isSeller())
                            <div class="d-flex align-items-center justify-content-between flex-wrap">
                                <div>
                                    ...
                                    <div class="h4 fw-bold text-success">Rp
                                        {{ number_format($stats['total_revenue'] ?? 0, 0, ',', '.') }}</div>
                                </div>
                                <div class="d-flex gap-2">
                                    <a href="{{ route('wallet.index') }}" class="btn btn-success"><i
                                            class="fas fa-wallet me-1"></i>Lihat Dompet</a>
                                    <a href="{{ route('wallet.index') }}#topup" class="btn btn-outline-primary"><i
                                            class="fas fa-plus me-1"></i>Top Up</a>
                                </div>
                            </div>
                            <hr>
                            <div class="small text-muted">Riwayat singkat transaksi terakhir Anda ditampilkan pada halaman
                                Dompet.</div>
                        @else
            ...
            <div class="col-xl-4 col-lg-5">
                <div class="card shadow mb-4" style="border-radius: 15px; border: none;">
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between"
                        style="background: white; border-bottom: 1px solid #e3e6f0; border-radius: 15px 15px 0 0;">
                        <h6 class="m-0 font-weight-bold" style="color: #4e73df; font-size: 1rem;">Top Selling Products
                        </h6>
                        <a href="{{ Route::has('admin.products.index') ? route('admin.products.index') : route('admin.dashboard') }}"
                            class="btn btn-sm"
                            style="background: linear-gradient(135deg, #20c997 0%, #17a2b8 100%); border: none; color: white; border-radius: 8px; padding: 6px 16px; font-weight: 500; text-decoration: none; transition: all 0.3s ease;">
                            View All
                        </a>
                    </div>
                    <div class="card-body" style="padding: 1.5rem;">
                        @forelse($top_products as $product)
                            <div class="d-flex align-items-center mb-3"
                                style="padding: 0.75rem 0; border-bottom: 1px solid #f8f9fc;">
                                <div class="me-3">
                                    <img src="{{ asset('img/' . $product->image) }}" alt="{{ $product->name }}"
                                        class="img-fluid"
                                        style="width: 50px; height: 50px; object-fit: cover; border-radius: 10px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
                                </div>
                                <div class="flex-grow-1">
                                    <div class="fw-bold" style="color: #5a5c69; font-size: 0.95rem; margin-bottom: 2px;">
                                        {{ $product->name }}</div>
                                    <div class="text-muted" style="font-size: 0.8rem;">
                                        {{ number_format($product->sales_count) }} sold</div>
                                </div>
                ...
                <div class="card shadow-lg mb-4 quick-actions-card">
                    ...
                    <div class="card-body p-4">
                        <div class="row g-4">
                            ...
                            <div class="col-lg-3 col-md-6 mb-3">
                                <a href="{{ Route::has('admin.products.index') ? route('admin.products.index') : route('admin.dashboard') }}"
                                    class="quick-action-btn btn-manage-products">
                                    <div class="quick-action-icon">
