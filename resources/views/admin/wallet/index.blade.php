        ...
        <div class="container-fluid">
                ...
                <div class="col-md-3 col-sm-6 mb-3">
                    <div class="stats-card total">
                        ...
                        <div class="stats-content">
                            <h6>Total Saldo</h6>
                            <h3>Rp {{ number_format($adminWallet->total_balance, 0, ',', '.') }}</h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3 col-sm-6 mb-3">
                    <div class="stats-card success">
                        ...
                        <div class="stats-content">
                            ...
                            <h3>Rp {{ number_format($adminWallet->total_tax_collected, 0, ',', '.') }}</h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3 col-sm-6 mb-3">
                    <div class="stats-card warning">
                        ...
                        <div class="stats-content">
                            ...
                            <h3>Rp {{ number_format($todayTax, 0, ',', '.') }}</h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3 col-sm-6 mb-3">
                    <div class="stats-card info">
                        ...
                        <div class="stats-content">
                            ...
                            <h3>Rp {{ number_format($thisMonthTax, 0, ',', '.') }}</h3>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3 bg-primary text-white d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <a href="{{ route('admin.wallet.history') }}" class="btn btn-sm btn-light">
                            <i class="fas fa-list me-1"></i>Lihat Semua
                        </a>
                        <a href="{{ route('admin.wallet.export') }}" class="btn btn-sm btn-light">
                            <i class="fas fa-download me-1"></i>Export CSV
                        </a>
                    </div>
                </div>
                <div class="card-body">
                    @if($recentTaxes->count() > 0)
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    @forelse($recentTaxes as $tax)
                                        <tr>
                                            <td>
                                                <small>{{ $tax->created_at->format('d M Y, H:i') }}</small>
                                            </td>
                                            <td>
                                                @if($tax->order_id)
