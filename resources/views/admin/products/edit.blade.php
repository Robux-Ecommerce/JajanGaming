                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('game_name') is-invalid @enderror"
                                        id="game_name" name="game_name" value="{{ old('game_name', $product->game_name) }}"
                                        required>
                                    @error('game_name')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select @error('game_type') is-invalid @enderror" id="game_type"
                                        ...
                                        <option value="Robux"
                                            {{ old('game_type', $product->game_type) == 'Robux' ? 'selected' : '' }}>Robux
                                        </option>
                                        <option value="Premium"
                                            {{ old('game_type', $product->game_type) == 'Premium' ? 'selected' : '' }}>
                                            Premium</option>
                                        <option value="Game Pass"
                                            {{ old('game_type', $product->game_type) == 'Game Pass' ? 'selected' : '' }}>
                                            Game Pass</option>
                                    </select>
                                    @error('game_type')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                @if (auth()->user()->isAdmin())
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            name="seller_name" value="{{ old('seller_name', $product->seller_name) }}"
                                            required>
                                        @error('seller_name')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                @else
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" value="{{ $product->seller_name }}"
                                            readonly>
                            ...
                            @if (auth()->user()->isAdmin())
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                                    ...
                                                    <div class="col-6 col-md-3 mb-2">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio"
                                                                ...
                                                                {{ $product->image == 'sellers/robux dikit 1.png' ? 'checked' : '' }}>
                                                    ...
                                                    <div class="col-6 col-md-3 mb-2">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio"
                                                                ...
                                                                {{ $product->image == 'sellers/robux sedang 2.png' ? 'checked' : '' }}>
                                                    ...
                                                    <div class="col-6 col-md-3 mb-2">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio"
                                                                ...
                                                                {{ $product->image == 'sellers/robux banyak 2.png' ? 'checked' : '' }}>
                                                    ...
                                                    <div class="col-6 col-md-3 mb-2">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio"
                                                                ...
                                                                {{ $product->image == 'sellers/robux.png' ? 'checked' : '' }}>
                                        ...
                                        <input type="hidden" name="image" id="final_image"
                                            value="{{ $product->image }}">
                                    </div>
                                </div>
                            @else
                    ...
                    <div class="card-body">
                        <div class="row text-center">
                            <div class="col-6 mb-3">
                                <div class="text-primary font-weight-bold h4">{{ number_format($product->sales_count) }}
                                </div>
                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <div class="text-center">
                            ...
                            <div id="preview-price" class="text-success">Rp
