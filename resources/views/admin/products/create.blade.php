                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control @error('rating') is-invalid @enderror" 
                                       id="rating" name="rating" value="{{ old('rating', 0) }}" min="0" max="5" step="0.1" required>
                                @error('rating')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-6 col-md-3 mb-2">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="image_select" id="robux1" value="sellers/robux dikit 1.png">
                                            ...
                                            <div class="col-6 col-md-3 mb-2">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="image_select" id="robux2" value="sellers/robux sedang 2.png">
                                            ...
                                            <div class="col-6 col-md-3 mb-2">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="image_select" id="robux3" value="sellers/robux banyak 2.png">
                                            ...
                                            <div class="col-6 col-md-3 mb-2">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="image_select" id="robux4" value="sellers/robux.png">
                            ...
                            <div class="tab-content" id="imageTabContent">
                                ...
                                <div class="tab-pane fade" id="select" role="tabpanel">
                                    <div class="row">
                                        <div class="col-6 col-md-3 mb-2">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="image_select" id="robux1_seller" value="sellers/robux dikit 1.png">
                                        ...
                                        <div class="col-6 col-md-3 mb-2">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="image_select" id="robux2_seller" value="sellers/robux sedang 2.png">
                                        ...
                                        <div class="col-6 col-md-3 mb-2">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="image_select" id="robux3_seller" value="sellers/robux banyak 2.png">
                                        ...
                                        <div class="col-6 col-md-3 mb-2">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="image_select" id="robux4_seller" value="sellers/robux.png" checked>
            ...
            <div class="card shadow">
                ...
                <div class="card-body">
                    <div class="text-center">
                        ...
                        <div id="preview-description" class="text-muted small">Product description will appear here</div>
                    </div>
                </div>
            </div>
        </div>
