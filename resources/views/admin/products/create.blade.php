    ...
    <div class="container-fluid px-4">
        ...
        <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('game_name') is-invalid @enderror" 
                                           id="game_name" name="game_name" value="{{ old('game_name', 'Roblox') }}" placeholder="e.g. Roblox" required>
                                    @error('game_name')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select @error('game_type') is-invalid @enderror" 
                                        ...
                                        <option value="Robux" {{ old('game_type') == 'Robux' ? 'selected' : '' }}>Robux</option>
                                        <option value="Premium" {{ old('game_type') == 'Premium' ? 'selected' : '' }}>Premium</option>
                                        <option value="Game Pass" {{ old('game_type') == 'Game Pass' ? 'selected' : '' }}>Game Pass</option>
                                    </select>
                                    @error('game_type')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('seller_name') is-invalid @enderror" 
                                           id="seller_name" name="seller_name" value="{{ old('seller_name') }}" placeholder="Enter seller name" required>
                                    @error('seller_name')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" class="form-control @error('price') is-invalid @enderror" 
                                           id="price" name="price" value="{{ old('price') }}" placeholder="e.g. 50000" min="0" step="100" required>
                                    @error('price')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" class="form-control @error('quantity') is-invalid @enderror" 
                                           id="quantity" name="quantity" value="{{ old('quantity') }}" placeholder="e.g. 100" min="0" required>
                                    @error('quantity')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" class="form-control @error('rating') is-invalid @enderror" 
                                           id="rating" name="rating" value="{{ old('rating', 0) }}" placeholder="e.g. 4.5" min="0" max="5" step="0.1" required>
                                    @error('rating')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                            ...
                                            <div class="row g-2">
                                                <div class="col-6 col-md-3">
                                                    <div class="image-option">
                                                        <input class="form-check-input d-none" type="radio" name="image_select" id="robux1" value="sellers/robux dikit 1.png">
                                                ...
                                                <div class="col-6 col-md-3">
                                                    <div class="image-option">
                                                        <input class="form-check-input d-none" type="radio" name="image_select" id="robux2" value="sellers/robux sedang 2.png">
                                                ...
                                                <div class="col-6 col-md-3">
                                                    <div class="image-option">
                                                        <input class="form-check-input d-none" type="radio" name="image_select" id="robux3" value="sellers/robux banyak 2.png">
                                                ...
                                                <div class="col-6 col-md-3">
                                                    <div class="image-option">
                                                        <input class="form-check-input d-none" type="radio" name="image_select" id="robux4" value="sellers/robux.png">
                                ...
                                <div class="tab-content" id="imageTabContent">
                                    ...
                                    <div class="tab-pane fade" id="select" role="tabpanel">
                                        <div class="row g-2">
                                            <div class="col-6 col-md-3">
                                                <div class="image-option">
                                                    <input class="form-check-input d-none" type="radio" name="image_select" id="robux1_seller" value="sellers/robux dikit 1.png">
                                            ...
                                            <div class="col-6 col-md-3">
                                                <div class="image-option">
                                                    <input class="form-check-input d-none" type="radio" name="image_select" id="robux2_seller" value="sellers/robux sedang 2.png">
                                            ...
                                            <div class="col-6 col-md-3">
                                                <div class="image-option">
                                                    <input class="form-check-input d-none" type="radio" name="image_select" id="robux3_seller" value="sellers/robux banyak 2.png">
                                            ...
                                            <div class="col-6 col-md-3">
                                                <div class="image-option">
                                                    <input class="form-check-input d-none" type="radio" name="image_select" id="robux4_seller" value="sellers/robux.png" checked>
            ...
            <div class="col-lg-4">
                ...
                <div class="tips-card">
                    <div class="card-header-custom">
                        <h6><i class="fas fa-lightbulb me-2"></i>Helpful Tips</h6>
                    </div>
                    <div class="card-body-custom">
                        <ul class="tips-list">
                            <li>
                ...
                <div class="preview-card">
                    ...
                    <div class="preview-content">
                        <img src="{{ asset('img/sellers/robux.png') }}" alt="Product Preview" class="preview-image" id="preview-image">
                        <div class="preview-name" id="preview-name">Product Name</div>
                        <div class="preview-price" id="preview-price">Rp 0</div>
                        <div class="preview-description" id="preview-description">Product description will appear here</div>
                    </div>
                </div>
            </div>
        </div>
