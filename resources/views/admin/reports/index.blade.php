        ...
        <div class="card mb-6" style="margin-top: 2rem;">
            <div class="card-header" style="padding: 1.75rem;">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('admin.reports.export') }}" class="btn btn-sm" style="background: linear-gradient(135deg, #64a0b4 0%, #508ca0 100%); color: white; font-weight: 700; border: none; padding: 0.65rem 1.25rem; border-radius: 8px; transition: all 0.3s;">
                                ...
                                <td style="padding: 1.25rem 1rem; vertical-align: middle;">
                                    <div class="d-flex align-items-center gap-3">
                                        @if($seller->profile_photo)
                                            <img src="{{ asset('storage/' . $seller->profile_photo) }}" alt="Avatar" class="avatar-mini rounded-circle" style="width: 42px; height: 42px; object-fit: cover;">
                                        @else
                                            <div class="avatar-mini" style="width: 42px; height: 42px; font-size: 1.1rem;">{{ strtoupper(substr($seller->name, 0, 1)) }}</div>
                                        @endif
                                        <div>
                                            <strong style="display: block; color: #ffffff; margin-bottom: 0.25rem;">{{ $seller->name }}</strong>
                                            <small style="color: #7a8a9a; font-size: 0.85rem;">{{ $seller->email }}</small>
                                        </div>
                                    </div>
                                </td>
                                <td style="padding: 1.25rem 1rem; vertical-align: middle;">
                                    <span class="badge" style="background: linear-gradient(135deg, rgba(232, 176, 86, 0.2) 0%, rgba(216, 149, 64, 0.1) 100%); color: #ffa500; border: 1px solid rgba(232, 176, 86, 0.4); font-size: 0.9rem; padding: 0.65rem 1rem; font-weight: 700;">
                                        {{ $seller->reports_against_count }} laporan
                                    </span>
                                </td>
                                <td style="padding: 1.25rem 1rem; vertical-align: middle;">
