...
@section('title', 'Detail Transaksi - Seller')
...
<div class="dashboard-wrapper">
    ...
    <aside class="dashboard-sidebar" id="dashboardSidebar">
        ...
        <nav class="sidebar-menu">
            ...
            <a href="{{ route('seller.transactions') }}" class="menu-item active">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="product-list-mini">
                                            @foreach($sellerOrderItems->take(2) as $item)
                                                <div style="margin-bottom: 4px;">
                                                    <span style="color: #64a0b4;">{{ $item->product->name }}</span>
                                                    <small style="color: rgba(255, 255, 255, 0.5); display: block;">
                                                        Qty: {{ $item->quantity }} × Rp {{ number_format($item->price, 0, ',', '.') }}
                                                    </small>
                                                </div>
                                            @endforeach
                                            @if($sellerOrderItems->count() > 2)
                                                <small style="color: rgba(255, 255, 255, 0.5);">
                                                    +{{ $sellerOrderItems->count() - 2 }} produk lainnya
                                                </small>
                                            @endif
                                        </div>
                                    </td>
                                    <td>
                                        <span style="color: #ffffff; font-weight: 600;">
                                            {{ $sellerOrderItems->sum('quantity') }} item
                                        </span>
                                    </td>
                                    <td>
                                        <span class="amount">Rp {{ number_format($sellerOrderTotal, 0, ',', '.') }}</span>
                                    </td>
                                    <td>
