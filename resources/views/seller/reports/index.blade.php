    ...
    <aside class="dashboard-sidebar" id="dashboardSidebar">
        ...
        <div class="sidebar-user">
            ...
            <div class="sidebar-user-info">
                ...
                <span class="user-role">{{ auth()->user()->isSeller() ? 'Penjual' : 'Pelanggan' }}</span>
            </div>
        </div>
                ...
                <table class="table">
                    ...
                    <tbody>
                        @forelse($reports as $report)
                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content" style="background: linear-gradient(135deg, #1a2a38 0%, #243645 100%); border: 1px solid rgba(100, 160, 180, 0.2); color: #e0e0e0;">
                                        ...
                                        <div class="modal-footer" style="border-top: 1px solid rgba(100, 160, 180, 0.2);">
                                            ...
                                            @if($report->status === 'pending' && !$report->seller_response)
                                                <button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#respondModal{{ $report->id }}" style="background: linear-gradient(135deg, #64a0b4 0%, #4a8a9e 100%); color: white; border: none; font-weight: 600;">
                            ...
                            <!-- Response Modal -->
                            <div class="modal fade" id="respondModal{{ $report->id }}" tabindex="-1">
                                <div class="modal-dialog">
                                    <div class="modal-content" style="background: linear-gradient(135deg, #1a2a38 0%, #243645 100%); border: 1px solid rgba(100, 160, 180, 0.2); color: #e0e0e0;">
                                        ...
                                        <form action="{{ route('seller.reports.respond', $report->id) }}" method="POST">
                                            @csrf
                                            <div class="modal-body">
